...
function canActNow(){
  ...
  if(STATE.net.paused) return {ok:false, reason:'⏸️ Spiel pausiert'};
...
function handleServerMessage(msg){
  ...
  if(t === "room_update"){
    ...
    const roleTxt = (STATE.net.myColor ? `Du bist ${STATE.net.myColor.toUpperCase()}` : (STATE.net.role||'spectator'));
